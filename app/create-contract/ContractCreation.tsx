  ...
  const generateContract = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Format filename: Contrato_CompanyName_Date
        const today = new Date()
        const dateStr = today.toISOString().split("T")[0] // YYYY-MM-DD format
        const filename = `Contrato_${contractData.companyName.replace(/\s+/g, "_")}_${dateStr}.html`
        ...
        alert(`Contract generated successfully! File: ${filename}`)
      } else {
